...
import com.mooc.house.api.common.*;
...
public class HouseController {
  ...
  @RequestMapping(value="house/lastest",method={RequestMethod.POST,RequestMethod.GET})
  @ResponseBody
  public ResultMsg lastest(){
    RestResponse<List<House>> lastest = houseService.lastest();
    logger.info(lastest.toString());
    return ResultMsg.success();
  }
}
